        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white">Specialized Treatment</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white">Emergency Care</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white">Preventive Medicine</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white">Telemedicine</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <p className="flex items-center">
                ...
                <span className="text-gray-400">info@healthcare.com</span>
              </p>
            </div>
          </div>
        </div>
